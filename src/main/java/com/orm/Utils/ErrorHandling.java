...
public class ErrorHandling {
    ...
    static void validateId(int id, Logger logger) {
        if (id <= 0) {
    ...
    static <T> void validateClz(Class<T> clz, Logger logger) {
        if (clz == null) {
    ...
    static <T> void validateItem(T item, Logger logger) {
        if (item == null) {
    ...
    static void validatePropertyName(String propertyName, Logger logger) {
